...
from custom_components.tk_husteblume import async_reload_entry
from custom_components.tk_husteblume import async_setup_entry
from custom_components.tk_husteblume import async_unload_entry
...
async def test_setup_unload_and_reload_entry(hass, bypass_get_data):
    ...
    # call, no code from custom_components/tk_husteblume/api.py actually runs.
    assert await async_setup_entry(hass, config_entry)
    assert DOMAIN in hass.data and config_entry.entry_id in hass.data[DOMAIN]
    assert hass.data[DOMAIN][config_entry.entry_id] is TkHusteblumeDataUpdateCoordinator
